...
$sql = $pdo->prepare("INSERT INTO form_input(kode_barang, nama_barang, qty, harga_bandrol, diskon_pct, diskon_nilai, harga_diskon, total) VALUES(:kode_barang,:nama_barang,:qty,:harga_bandrol,:diskon_pct, :diskon_nilai, :harga_diskon, :total)");
