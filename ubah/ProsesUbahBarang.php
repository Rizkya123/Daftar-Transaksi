...
$sql = $pdo->prepare("UPDATE barang SET kode_barang=:kode_barang, nama_barang=:nama_barang, qty=:qty, harga_bandrol=:harga_bandrol, diskon_pct=:diskon_pct, diskon_nilai=:diskon_nilai, harga_diskon=:harga_diskon, total=:total WHERE id=:id");
